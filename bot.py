...
bot = telepot.Bot("658499033:AAGjTteT8SUFjEDDDCcBRr0C6GeIa_6Plmw")
...
def main(msg):
 ...
 if(text.upper() == "/START"):
  bot.sendMessage(id2, f"""OLÁ <b>{id1}!</b> Seja Bem Vindo Ao <b>EXAMPLECURBY</b> Digite o Comando /ferramentas para visualizar meu menu""", "html")
...
<b>BY:</b> @ExxaplaCBOT""", parse_mode="html", reply_to_message_id=msg["message_id"])
...
<b>CEP:</b> <pre>{cep}</pre>
<b>BY:<b> @ExxaplaCBot""", "html", reply_to_message_id=msg["message_id"])
  except:
   bot.sendMessage(id2, "<b>CPF NÃO ENCONTRADO!</b>", "html", reply_to_message_id=msg["message_id"])
